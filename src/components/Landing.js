...
export default function landing() {
    return (
        ...
        <Link to="/rentals"><a href="/rentals" className="Logo"><img src={logo} style={{display: 'flex',  justifyContent:'center', alignItems:'center', height: '20vh', onLoad: 'fadeIn'}} alt='Logo'/></a></Link>
        </div> 
    )
}
